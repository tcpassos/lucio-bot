    ...
    public void addJdaCommands(JDA jda) {
        ...
        globalCommands.addCommands(
                ...
                Commands.slash("mix", messageService.getMessage("command.mix.description"))
                        .addSubcommands(
                        new SubcommandData("artists", messageService.getMessage("command.mix.subcommand.artists"))
                                .addOption(OptionType.STRING, "artist1", messageService.getMessage("command.mix.param.artist"), true)
